  ...
  return (
    ...
    >
      ...
      <div className="bg-[#F7C7D9] h-[75%] w-[60%] mx-auto mt-8 rounded-xl flex flex-col items-center p-6">
        <h1 className="text-black font-[Kameron] text-5xl text-center p-4 pt-6">
        ...
        <button
          ...
          className="bg-[#6E3FA7] p-2 px-6 rounded-md mt-4 text-[#FEF9F1] text-xl font-[Kameron] hover:bg-[#47267A] transition duration-200 ease-in-out"
        >
          Submit
        </button>
      </div>
